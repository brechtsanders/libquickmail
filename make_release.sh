...
FILELIST='*.c *.h *.am *.in README AUTHORS COPYING License.txt NEWS ChangeLog INSTALL INSTALL.msys man1 configure.ac configure autogen.sh autom4te.cache config.guess config.sub depcomp install-sh ltmain.sh *.m4 m4 missing'
